...
export default function Hero() {
  return (
    <section className='relative p-8 pt-44 pb-24 lg:fixed lg:w-50 lg:h-full lg:flex lg:flex-col lg:justify-center lg:items-end lg:w-1/2 xl:px-24 2xl:px-36'>
      ...
      <a
        className='bg-violet-500 text-black font-medium py-2 px-6 rounded hover:bg-violet-400 transition duration-300 ease-in-out w-fit'
        href='#about-me'
      >
        About me
      </a>
